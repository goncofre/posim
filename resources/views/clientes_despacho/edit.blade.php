...
@section('title', 'Editar Cliente: ' . $clienteDespacho->nombre_completo)

@section('content')
    <div class="container">
        <h1>Editar Cliente: {{ $clienteDespacho->nombre_completo }}</h1>
        
        <div class="card shadow-sm">
            <div class="card-header">
                Modificar Datos de Contacto y Despacho
            </div>
            <div class="card-body">
                
                {{-- Formulario que apunta a la ruta 'clientes_despacho.update' y usa el método PUT --}}
                <form action="{{ route('clientes_despacho.update', $clienteDespacho->id) }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="nombre_completo" id="nombre_completo" 
                               ...
                               value="{{ old('nombre_completo', $clienteDespacho->nombre_completo) }}" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="rut_fiscal" id="rut_fiscal" 
                               ...
                               value="{{ old('rut_fiscal', $clienteDespacho->rut_fiscal) }}">
                        @error('rut_fiscal')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="direccion_despacho" id="direccion_despacho" 
                               ...
                               value="{{ old('direccion_despacho', $clienteDespacho->direccion_despacho) }}" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="tel" name="telefono" id="telefono" 
                               ...
                               value="{{ old('telefono', $clienteDespacho->telefono) }}">
                        @error('telefono')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="email" name="email" id="email" 
                               ...
                               value="{{ old('email', $clienteDespacho->email) }}">
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
